make_plots_function <- function(x, plotpath, name = "metadata_QC"){
  ...
  ggsave(filename = paste(plotpath, "/1.pdf", sep = ""), plots[[1]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/2.pdf", sep = ""), plots[[2]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/3.pdf", sep = ""), plots[[3]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/4.pdf", sep = ""), plots[[4]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/5.pdf", sep = ""), plots[[5]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/6.pdf", sep = ""), plots[[6]], width = 30, height = 20)
  ggsave(filename = paste(plotpath, "/7.pdf", sep = ""), plots[[7]], width = 30, height = 20)
}
